...
public partial class LoginTermProjectDbContext : DbContext
{
    public LoginTermProjectDbContext()
    {
    }

    public LoginTermProjectDbContext(DbContextOptions<LoginTermProjectDbContext> options)
        : base(options)
    {
    }
